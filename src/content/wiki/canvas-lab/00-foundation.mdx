...
**Try this:** Change the rectangle's fill color to `'#ff2d7b'` and move the circle by editing its center coordinates in the `ctx.arc()` call. Watch how the coordinate system maps to actual positions on canvas.
</Concept>
